...
// Пример: https://github.com/vpashka/uniset-example-go
//
// \todo логирование для объектов
// -------------------
package uniset
...
func SetValue(ch chan<- UMessage, sid ObjectID, value int64) {
